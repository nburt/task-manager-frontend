...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_Root2.default, null), document.getElementById('task-manager'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _configureStore2.default)({ tasks: [] });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(initialState) {
	    return (0, _redux.createStore)(_tasks2.default, initialState, (0, _redux.applyMiddleware)(_reduxThunk2.default));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function tasks() {
	    ...
	    switch (action.type) {
	        ...
	        case _ActionTypes.RECEIVE_TASKS:
	            return Object.assign({}, state, { tasks: action.tasks });
	        case _ActionTypes.REQUEST_TASKS:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TaskManager = __webpack_require__(192);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_TaskManager2.default, { tasks: tasks, actions: actions, url: 'https://morning-hollows-57260.herokuapp.com/tasks' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewTaskForm = __webpack_require__(193);

	var _NewTaskForm2 = _interopRequireDefault(_NewTaskForm);

	var _TaskList = __webpack_require__(194);
	...
	var TaskManager = function (_Component) {
	    ...
	    function TaskManager(props, context) {
	        _classCallCheck(this, TaskManager);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TaskManager).call(this, props, context));
	    ...
	    _createClass(TaskManager, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_NewTaskForm2.default, { url: url, handleTaskSubmit: this.handleTaskSubmit }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewTaskForm = function (_Component) {
	    _inherits(NewTaskForm, _Component);

	    function NewTaskForm(props, context) {
	        _classCallCheck(this, NewTaskForm);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NewTaskForm).call(this, props, context));
	    ...
	    _createClass(NewTaskForm, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'form',
	                { className: 'newTaskForm', onSubmit: this.handleSubmit },
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('input', { type: 'text', id: 'task-name', value: this.state.name, onChange: this.handleNameChange })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'form-field' },
	                    ...
	                    _react2.default.createElement('textarea', { id: 'task-description', value: this.state.description,
	                        onChange: this.handleDescriptionChange })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'form-field' },
	                    _react2.default.createElement('input', { type: 'submit', value: 'Create Task', className: 'button button-primary' })
	                )
	            );
	        }
	    }]);
	...
	NewTaskForm.propTypes = {
	    ...
	    handleTaskSubmit: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskList = function (_Component) {
	    ...
	    function TaskList(props, context) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TaskList).call(this, props, context));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(196).polyfill();
	__webpack_require__(200);

	function addTask(id, name, description) {
	    return {
	        type: types.ADD_TASK, id: id, name: name, description: description
	    };
	}
	...
	function fetchTasks() {
	    return function (dispatch) {
	        ...
	        return fetch('https://morning-hollows-57260.herokuapp.com/tasks').then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5), (function() { return this; }()), __webpack_require__(197)(module)))
